  ...
  "Adaptação (Iniciante)": [
    {
      ...
      weight: 20,
      rest: 60,
      imageUrl: "/imagens/leg-press.webp",
      specs: "Foco na amplitude.",
    },
    {
      name: "Supino Máquina",
      series: 3,
      ...
      weight: 10,
      rest: 60,
      imageUrl: "/imagens/supino-reto-barra.webp",
      specs: "Controle o movimento.",
    },
    {
      name: "Puxada Frente",
      series: 3,
      ...
      weight: 20,
      rest: 60,
      imageUrl: "/imagens/puxada-frente.webp",
      specs: "Não balance o tronco.",
    },
  ],
  "Hipertrofia A (Push)": [
    {
    ...
    },
    {
      ...
      weight: 12,
      rest: 60,
      imageUrl: "/imagens/desenvolvimento-ombro.webp",
      specs: "Coluna bem apoiada.",
    },
  ],
  "Treino Funcional": [
    {
      ...
      weight: 0,
      rest: 45,
      imageUrl: "/imagens/agachamento.webp",
      specs: "Mantenha o ritmo.",
    },
    {
      ...
      weight: 0,
      rest: 30,
      imageUrl: "/imagens/prancha.webp",
      specs: "Contraia o abdômen.",
    },
  ],
};
...
const sugestoes = [
  {
    nome: "Adaptação (Iniciante)",
    cor: "#22c55e",
    desc: "Ideal para quem está começando agora.",
  },
  {
    nome: "Hipertrofia A (Push)",
    cor: "#3b82f6",
    desc: "Foco em Peito, Ombro e Tríceps.",
  },
  {
    nome: "Treino Funcional",
    cor: "#f59e0b",
    desc: "Queima calórica e condicionamento.",
  },
];
...
export function Workouts() {
  ...
  const aplicarModelo = async (nomeModelo: string) => {
    ...
    const confirmacao = window.confirm(
      `Deseja adicionar o modelo "${nomeModelo}" aos seus treinos?`
    );
  ...
  if (loading)
    return <div className="app-container">Carregando treinos...</div>;
        ...
        {workouts.length === 0 ? (
          <div className={styles.emptyContainer}>
            ...
            <p className={styles.subtitle}>
              Escolha um pronto para começar ou Manualmente:
            </p>
          ...
          <div className={styles.list}>
            ...
            <button
              onClick={() => navigate("/add-workout")}
              className={styles.btnAddFloating}
            >
              + Novo Treino
            </button>
          </div>
